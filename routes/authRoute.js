...
router.route('/register').get(getLoginUser, getRegisterView).post(getLoginUser, bouncer.block, registerUsers);

router.route('/login').get(getLoginUser, getLoginView).post(getLoginUser, bouncer.block, loginUsers);
...
router.route('/resetpassword/:resettoken').get(getResetPasswordView).put(resetPassword);
